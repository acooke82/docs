...
![image shows a picture of the VIVI platform](/)
...
**Why VIVI?** You control the whole workflow of your agents, end-to-end. 
Need voice capabilites? Yeah, we got that too. Experience the power of realtime voice models. 

## Need Ideas?  

<Columns cols={4}>
  <Card title="Technical Suport">
    Multilingual, 24/7 support. Real answers in real time.
  </Card>
  <Card title="Lead Generation">
    
  </Card>
  <Card title="Hotel Concierge">
